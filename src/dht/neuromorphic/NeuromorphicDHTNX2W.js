/**
 * NeuromorphicDHTNX2W (NX-1W) – Fully Configurable Neuromorphic DHT
 *
...
export class NeuromorphicDHTNX2W extends DHT {
  static get protocolName() { return 'Neuromorphic-NX2W'; }
  ...
  _stratifiedAdd(node, newSyn) {
    ...
    if (!this.EN_STRATIFIED) {
      // Simple eviction: weakest connection
